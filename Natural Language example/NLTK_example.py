...
LINES = ['-',':','--'] # lines styles for plotting
...
def word_length_test(words_by_author, len_shortest_corpus):
    """Plot word length freq b author, truncated to shortest corpus length."""
...
def stopwords_test(words_by_author, len_shortest_corpus):
    """Plot stowords freq by author, truncated to shortest corpus length."""
...
def vocab_test(words_by_author):
    """ Compare author vocabularies using the chi-square test."""
