...
class Search():
    ...
    def __init__(self, name):
        ...
        self.area_actual=0
        self.sailor_actual = [0,0] # pixel coordinates
    ...
    def draw_map(self, last_known):
        """ Display baseline with scale,last known xy location, search areas."""
    ...
    def sailor_final_location(self,num_search_areas):
        """Return the actual x,y locatioan of the missing sailor """
        # Find sailor coordinates with respect to any Search Area Subarra.
...
def draw_menu(search_num):
    """Print menu of choices for conducting area of searches."""
